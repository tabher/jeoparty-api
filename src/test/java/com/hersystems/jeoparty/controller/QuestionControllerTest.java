...
class QuestionControllerTest {
    ...
    public void givenGetQuestions_whenQuestionsExist_thenReturnHttpStatus200() throws ResourceNotFoundException {
        //arrange
        when(mockQuestionService.findAllQuestions()).thenReturn(questionList);
        //act
        ResponseEntity actual = underTest.getQuestions();
        //assert
    ...
    public void givenGetQuestions_whenQuestionsDontExist_thenReturnHttpStatus404() throws ResourceNotFoundException {
        //arrange
        when(mockQuestionService.findAllQuestions()).thenThrow(ResourceNotFoundException.class);
        //act
        //assert
        assertThrows(ResourceNotFoundException.class, () -> underTest.getQuestions());
    }
}